                ...
                <ul class="list-unstyled">
                    ...
                    <li class="dropdown pc-h-item header-user-profile">
                        <a class="pc-head-link head-link-primary dropdown-toggle arrow-none me-0"
                            data-bs-toggle="dropdown" href="#" role="button" aria-haspopup="false"
                            aria-expanded="false">
                            <img src="../assets/images/user/avatar-2.svg" alt="user-image" class="user-avtar" />
                            <span>
                        ...
                        <div class="dropdown-menu dropdown-user-profile dropdown-menu-end pc-h-dropdown">
                            <div class="dropdown-header">
                                <h4>
                                    Good Morning,
                                    <span class="small text-muted"><?php echo htmlspecialchars($_SESSION['admin_name']); ?></span>
                                </h4>
                                ...
                                <div class="profile-notification-scroll position-relative"
                                    ...
                                    <a href="javascript:void(0)" class="dropdown-item" onclick="showLogoutToast()">
    ...
    <div class="toast-container position-fixed top-0 end-0 p-3">
        <div id="logoutToast" class="toast text-bg-warning border-0" role="alert" aria-live="assertive"
            aria-atomic="true">
