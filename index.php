                        ...
                        <div class="card-body">
                            ...
                            <div class="d-grid">
                                <button type="button" class="btn mt-2 bg-light-primary bg-light text-muted">
                                    <img src="assets/images/authentication/google-icon.svg" alt="image">
                                    Sign In With Google
                                </button>
                            </div>
                            ...
                            <div class="form-floating mb-3">
                                <input type="email" class="form-control" id="floatingInput"
                                    placeholder="Email address / Username" name="email">
                            ...
                            <div class="d-flex mt-1 justify-content-between">
                                ...
                                <h5 class="text-secondary"><a href="forgot_password.php">Forgot Password?</a></h5>
                            </div>
